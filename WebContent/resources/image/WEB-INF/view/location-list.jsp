          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">All Location</h3>
                ...
                <table class="table table-bordered">
                  <thead>                  
                    <tr>
                      ...
                      <th class="text-center">Week Days</th>
                    ...
                    <tr>
                      ...
                      <td>
                       ...
                       <td>
                        ...
                        <img src="${location.image}" style="max-width: 80px;">
                      </td>
                      <td class="text-center">
                        <div class="btn-group">
                          ...
                          <button type="button" class="btn btn-info" data-toggle="modal" data-target="#delete-modal-${location.id}">
    ...
    <div class="modal fade" id="delete-modal">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <a href="location-form"> <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button></a>
