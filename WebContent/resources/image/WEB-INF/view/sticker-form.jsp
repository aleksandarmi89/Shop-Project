          ...
          <div class="col-md-6">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Product Sticker Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <form:form action="sticker-save" modelAttribute="sticker" role="form">
              <form:hidden path="id"/>
                <div class="card-body">
...
<!-- Bootstrap 4 -->
<script src="${pageContext.request.contextPath}/admin/plugins/bootstrap/js/bootstrap.bundle.min.js">
