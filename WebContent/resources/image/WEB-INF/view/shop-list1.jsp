                        ...
                        <form class="filter-form" method="GET" action="">
                            ...
                            <div class="form-group mb-5">
                                ...
                                <select class="form-control" name="category">
                                    ...
                                    <c:choose>
                                    <c:when test="${category.id==proba.id}">
                                     <option value="${category.id} " selected>${category.name} </option> 
                                     </c:when>
                                     <c:otherwise><option value="${category.id} ">${category.name} </option>
                                     </c:otherwise>
                                     </c:choose>
                            ...
                            <div class="form-group mb-5">
                                ...
                                <label class="d-flex">
                                    ...
                                    <c:if test="${probaPrice==1}"> checked="checked" </c:if>
                                    >
                                    &lt; 5000
                                ...
                                <label class="d-flex">
                                    <input type="radio" name="price" value="2"
                                     <c:if test="${probaPrice==2}"> checked="checked" </c:if>
                                    >
                                    &lt; 10000
                                    <span class="fake-element"></span>
                                </label>
                                <label class="d-flex">
                                    <input type="radio" name="price" value="3"
                                     <c:if test="${probaPrice==3}"> checked="checked" </c:if>
                                    >
                                    &lt; 15000
                                    <span class="fake-element"></span>
                                </label>
                            ...
                            <div class="col-xxm-6 col-md-4">
                                <article class="popular-products-item mb-2
                                    ...
                                    <figure class="mb-3 d-flex
                                        ...
                                        align-items-center">
                                        <a href="product-shop-detail/${product.ceoTitle}/${product.id}" class="d-block"><img src="${product.image}"
                                                alt="" /></a>
                             ...
                             <p style="background-color: ${s.color};" class="discount">
                                ${s.title}
                                    ...
                                    <div class="popular-products-details
                                        ...
                                        <h5 class="mb-1"><a href="product-shop-detail/${product.ceoTitle}/${product.id}" class="text-uppercase">${product.category.name}
                                                </a></h5>
