            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <div class="single-product-details">
                        ...
                        <h5 class="text-uppercase">${product.formatedPrice}</h5>
                    </div>
                </div>
            </div>
        </div>
                ...
                <li>
                    <article class="popular-products-item mb-2 mb-lg-0">
                        <figure class="mb-3 d-flex justify-content-center align-items-center">
                            <a href="${pageContext.request.contextPath}/shop-detail/${p.ceoTitle}/${p.id}" class="d-block"><img width="auto" height="200" src="${p.image}" alt="" /></a>
                        </figure>
                        <div class="popular-products-details text-center text-lg-left">
                            ...
                            <p class="text-uppercase">${p.formatedPrice}</p>
                        </div>
                    </article>
                </li>
			</c:forEach>
