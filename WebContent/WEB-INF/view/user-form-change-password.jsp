        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form:form action="user-save-change-password" role="form" modelAttribute="changePassword">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <form:input type="password" class="form-control" placeholder="Comfirm password" path="confirmPassword"/>
                      </div>
