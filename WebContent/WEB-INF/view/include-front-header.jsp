    ...
    <div class="container">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-12 col-lg-6 header-details text-center text-lg-left">
                ...
                <p><img class="clock" src="${pageContext.request.contextPath}/front/img/icons/clock.png" alt="" />${locations[0].workingdays} ${locations[0].weekdays}</p>
            ...
            <div class="collapse navbar-collapse mt-2 mt-lg-0" id="main-menu">
                <ul class="navbar-nav mr-auto mr-lg-0 mb-3 mb-lg-0
                 text-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/shop-list">Products</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/location">Location</a>
                    </li>
                    <li class="nav-item ">
