              ...
              <form:form role="form" action="location-save" modelAttribute="location">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <form:input type="text" class="form-control" placeholder="Enter work hour" path="workingdays"/>
                  </div>
                  <div class="form-group">
                    <label>Closed</label>
                    <form:input type="text" class="form-control" placeholder="Enter closed" path="weekdays"/>
                  </div>
                  <div class="form-group">
                    <label>Image</label>
                  ...
                  <div class="form-group">
                    ...
                    <form:input type="text" class="form-control" placeholder="Enter latitude" path="x"/>
                  </div>
                  <div class="form-group">
                    <label>Lognitude</label>
                    <form:input type="text" class="form-control" placeholder="Enter lognitude" path="y"/>
                  </div>
                </div>
                <!-- /.card-body -->
