                    ...
                    <div class="col-lg-3 sidebar">
                        ...
                        <form class="filter-form" method="GET" action="">
                            ...
                            <div class="form-group mb-5">
                               ...
                               <c:choose>
                               		<c:when test="${category.id ==  categorySelected.id}">
                            ...
                            <div class="form-group mb-5">
                                ...
                                <label class="d-flex">
                                    <input type="checkbox" name="sticker" value="${sticker.id}"<c:if test="${Array.contains(sticker.id)}">checked="checked"</c:if>
                                    >
                                    ${sticker.title}
                            ...
                            <div class="col-xxm-6 col-md-4">
                                <article class="popular-products-item mb-2
                                    ...
                                    <figure class="mb-3 d-flex
                                        ...
                                        align-items-center">
                                        <a href="shop-detail/${product.ceoTitle}/${product.id}" class="d-block"><img width="auto" height="200" src="${product.image}"
                                                alt="" /></a>
