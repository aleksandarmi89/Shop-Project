                ...
                <div class="col-md-6">
                    <article class="contact-details text-uppercase">
                        ...
                        <div class="contact-group">
                            ...
                            <c:if test="${locations[0].phone2!=null&&locations[0].phone2!=''}">
                            <p>Phone 2: <a href="#">${locations[0].phone2}</a></p></c:if>
                        </div>
                        <div class="contact-group">
                        ...
                        <div class="contact-group">
                            <p>RADNO VREME:</p>
                            <p class="contact-medium">${locations[0].workingdays }</p>
                            <p class="contact-medium">${locations[0].weekdays}</p>
                        </div>
                    </article>
                </div>
            </div>
